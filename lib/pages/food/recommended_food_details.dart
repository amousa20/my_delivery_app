            ...
            child: Column(
              children: [
                Container(
                  ...
                  child:   ExpandableTextWidget(expandText: product.description!),
                ),
              ],
            ),
          ),
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: AppIcon(icon: Icons.remove,iconColor: Colors.white,backgroundColor: AppColors.mainColor,iconSize: Dimensions.iconSize24,),
                  ),
