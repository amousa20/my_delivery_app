            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                    bottomRight: Radius.circular(Dimensions.radius15/2),
                  bottomLeft: Radius.circular(Dimensions.radius15/2),
                ),
              ),
              height: Dimensions.height10*10,
              width: double.maxFinite,
              padding: EdgeInsets.only(top: Dimensions.height45,right: Dimensions.width10,left: Dimensions.width10),
              child: Row(
         ...
         GetBuilder<CartController>(builder: (_cartController){
           return _cartController.getCartHistoryList().length>0? Expanded(
             ...
             height: MediaQuery.of(context).size.height/1.5,
               child: const Center(
                 child: NoDataPage(
                   text: "Your didnt buy anything so far !",
