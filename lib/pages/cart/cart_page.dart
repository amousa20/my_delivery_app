                                      ...
                                      onTap: () {
                                        ...
                                        if (popularIndex>=0) {
                                          ...
                                          if(recommendedIndex<0){
                                            Get.snackbar("History Product", "Product review in not available for history product " , backgroundColor: AppColors.mainColor,colorText: Colors.white);
                                          }else{
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                              image: (CachedNetworkImageProvider(AppConstants.BASE_URL+AppConstants.UPLOAD_URL+cartController.getItems[index].img!)),
                                              fit: BoxFit.cover,
                                            ),
